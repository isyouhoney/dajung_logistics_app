...
abstract class $LoginInfoCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String loginNumber, String refreshToken, String fcmToken, User user});
...
/// @nodoc
@JsonSerializable()
class _$LoginInfoImpl extends _LoginInfo {
  _$LoginInfoImpl(
  ...
  @override
  String toString() {
    return 'LoginInfo(loginNumber: $loginNumber, refreshToken: $refreshToken, fcmToken: $fcmToken, user: $user)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, loginNumber, refreshToken, fcmToken, user);
...
abstract class _LoginInfo extends LoginInfo {
  factory _LoginInfo(
      ...
      required final User user}) = _$LoginInfoImpl;
